...
<body>
  ...
  <!--Navvar-->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" >
     ...
     <div class="card card-body text-center contenedor " style="width:700px;">
            ...
            <h2 class="display-5">Ruta más eficiente del camión N°<?php echo $C ?></h2><hr>
            <?php
            ...
            <br><table class="table table-striped table-bordered bg-white table-sm"> <caption>  </caption>
              <thead>
                <tr>
                  <th id="Secuencia" class="text-center pl-2 pr-3">Secuencia de ruta</th>
            ...
            <form action="mostrarcentros.php">
              <input type="submit" class="btn btn-secondary btn-block centrar-btn" value="Crear otra ruta.">
              </form>
