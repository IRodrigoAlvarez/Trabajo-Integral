      ...
      <div class="col-md-6 contenedor pl-2 mt-0">
        <table class="table table-striped table-bordered bg-white table-sm">
            <thead>
                ...
                <tr>
                    <td class="text-center">Centros de Distribucion</td>
                    <td class="text-center">NumeroIdentificador</td>
                    <td class="text-center">Camiones</td>
                </tr>
                ...
                ?>
                    ...
                    <tbody>
                    <tr>
                        <td><center><?php echo $mostrar['TipoLocal']?></center></td>
                        ...
                        <input type="hidden" name="centro_dib" value="<?php echo $mostrar['NumeroIdentificador']?>">
                ...
                ?>
                  ...
                  <?php
                    ...
                    <tbody>
                    <tr>
                        <td><center><?php echo $mostrar2['TipoLocal']?></center></td>
                        <td><center><?php echo $mostrar2['NumeroIdentificador']?></center></td>
